const defineGauge = () => {
  ...
  const formatNumber = (...numberString) => {
    ...
    num = 1 <= [...numberString].length ? slice.call([...numberString], 0) : [];
    value = num[0];
    digits = 0 || num[1];
  ...
  const BaseGauge = (function(superClass) {
  ...
  const AnimatedText = (function(superClass) {
  ...
  const GaugePointer = (function(superClass) {
  ...
  const Gauge = (function(superClass) {
  ...
  const BaseDonut = (function(superClass) {
  ...
  const Donut = (function(superClass) {
